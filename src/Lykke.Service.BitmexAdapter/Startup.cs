...
using Lykke.Service.BitmexAdapter.Settings;
...
namespace Lykke.Service.BitmexAdapter
{
    [UsedImplicitly]
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            return services.BuildServiceProvider<AppSettings>(options =>
            {
                ...
                options.Logs = logs =>
                {
                    logs.AzureTableName = "BitmexAdapterLog";
                    logs.AzureTableConnectionStringResolver = settings => settings.BitmexAdapterService.Db.LogsConnString;
                    ...
                    logs.Extended = extendedLogs =>
                    {
                        ...
                        extendedLogs.AddAdditionalSlackChannel("BitmexAdapter", channelOptions =>
                        {
